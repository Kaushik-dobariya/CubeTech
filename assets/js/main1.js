...
(function ($) {
	...
	function mobileMenu() {
		if ($(".mobile-menu").length) {
			 var mobileMenuContent = $(".tv-header .main-menu .navigation").clone();

        /* Remove mega menu from mobile clone */
        mobileMenuContent.find("#services-menu_mega").remove();

        /* Ensure normal Services menu is visible */
        mobileMenuContent.find("#services-menu").show();

        /* Mobile Menu */
        $(".mobile-menu .navigation").append(mobileMenuContent);

        /* Sticky Header */
        $('.sticky-header .navigation').append($(".tv-header .main-menu .navigation").clone());
